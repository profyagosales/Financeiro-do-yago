...
const sections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: "item", label: "Lista de Desejos", to: "/listas/desejos", icon: Gift },
      { type: "item", label: "Lista de Compras", to: "/listas/compras", icon: ShoppingCart },
    ],
  },
];
          ...
          <div className="p-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" side="top" className="w-40">
                <DropdownMenuItem onSelect={() => navigate("/perfil")}>Ver perfil</DropdownMenuItem>
        ...
        [
          ...
          isActive
            ? leaf.label === "Visão geral"
              ? "sb-active bg-gradient-to-r from-emerald-600/20 to-emerald-400/20 text-emerald-200 ring-2 ring-emerald-400/40"
