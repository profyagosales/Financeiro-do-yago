...
export default function GoalsProgressCard(){
  ...
  if (isLoading) return <div className="rounded-lg border-t-4 border-[var(--clr-metas)] bg-white shadow-sm p-6" aria-label="Metas"><Skeleton className="h-20 w-full" /></div>;
  return (
    <div className="rounded-lg border-t-4 border-[var(--clr-metas)] bg-white shadow-sm p-6" aria-label="Metas">
